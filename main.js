...
classifier = ml5.imageClassifier('https://teachablemachine.withgoogle.com/models/POUT-7O7u/model.json',modelLoaded);
...
function gotResult(error, results) {
  if (error) {
    ...
    if(results[1].label == "Supper")
    {
	    document.getElementById("update_emoji").innerHTML = "&#128076";        
    }
    if(results[1].label == "Hifi")
    {
